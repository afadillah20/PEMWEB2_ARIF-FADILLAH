...
<style>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="form_nilai_switch.php" method="POST" class="form-horizontal">
...
<?php
    ...
    if ($nilai >= 85 && $nilai <= 100){
        ...
        switch ($predikat) {
            case 'A':
                echo '<br/>Kategori : Sangat Memuaskan';
                break;
            case 'B':
                echo '<br/>Kategori : Memuaskan';
                break;
            case 'C':
                echo '<br/>Kategori : Cukup';
                break;
            case 'D':
                echo '<br/>Kategori : Kurang';
                break;
            case 'E':
                echo '<br/>Kategori : Sangat Kurang';
                break;
            default:
                echo '<br/>Kategori : Tidak ada';
                break;
        }
?>
        </div>
